...
---
This is another _really_ silly Sacred Harp one. Someone called [_404 Youth Will Soon Be Gone_](https://fasola.org/indexes/1991/?p=404) at a Newcastles singing recently and someone said [Error Not Found](https://en.wikipedia.org/wiki/HTTP_404). As a result, this is a list of Sacred Harp songs that are also [HTTP Status Codes](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status).
